...
This package is the source layout for a skill-oriented OpenAI Codex app agent for the Product and Requirements Manager role. The live Codex skill adapter stays repo-local at [`../../../../.agents/skills/product-requirements-manager`](../../../../.agents/skills/product-requirements-manager), while this folder holds the agent contract, backing assets, and builder notes that feed it.
...
- `agent/operating_rules.md`: clarify-first behavior, assumptions, boundaries, and escalation
- `agent/output_contracts.md`: output shapes by task type
...
- `../../../../.agents/skills/product-requirements-manager/`: repo-local skill instructions and adapter card
...
- Use the configured list when product work needs project-specific context from the projects area.
...
- Use the configured list when product work needs shared context from the information hub area.
...
6. Keep [`../../../../.agents/skills/product-requirements-manager`](../../../../.agents/skills/product-requirements-manager) aligned whenever the active agent contract changes.
