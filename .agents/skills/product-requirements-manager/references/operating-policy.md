...
- Use the listed projects as the default discovery scope unless the user narrows it.
...
- Use the listed information-hub folders as the default discovery scope unless the user narrows it.
