...
This folder is the canonical Product and Requirements Manager package for the Codex SDLC workspace.
...
- `assets/` holds deeper knowledge, eval, and training material.
