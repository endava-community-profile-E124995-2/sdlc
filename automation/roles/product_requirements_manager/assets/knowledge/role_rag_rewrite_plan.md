...
Convert `assets/knowledge/legacy_role_rag` from a broad reference pack into a production-grade retrieval and fine-tuning corpus for the Product and Requirements Manager agent.
