...
- `id`: Stable case ID such as `mesh.release.rollout_planning`.
...
- `example_prompt` should sound like a real request from engineering, quality, support, release, or operations stakeholders.
