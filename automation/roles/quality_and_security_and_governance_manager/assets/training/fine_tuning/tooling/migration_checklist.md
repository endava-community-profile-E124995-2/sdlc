...
- Convert broad review guidance into artifact contracts, interaction cases, examples, metrics, and risks.
- Add handoff cases back to product, architecture, and deployment for the most common ownership boundaries.
...
- Check that every example demonstrates evidence handling, role boundaries, and traceability.

## Phase 5: Variants

- Add context variants only after the base review behavior is stable.
...
- Add behavior cases for ambiguity, evidence quality, gates, and ownership boundaries.
