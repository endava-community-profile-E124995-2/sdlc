...
Keep the structured quality corpus internally consistent and safe for retrieval and fine-tuning use.
...
- Interaction cases must stay role-correct and must not take product, architecture, or deployment ownership unless they are explicitly framing a handoff.
